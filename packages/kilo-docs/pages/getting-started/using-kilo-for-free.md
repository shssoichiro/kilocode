...
{% callout type="tip" %}
The available free models change over time as Kilo partners with different AI inference providers. Subscribe to our blog or join our Discord for updates.
{% /callout %}
